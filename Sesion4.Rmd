...
Para determinar el numero de clusters que mejor se ajusta a los datos existe el metodo del codo, en el cual se calcula la distnacia media de los datos a se centroide y se va graficando esto, el numero optimo de clusters se tendra cuando se vea un "codo" en la linea:
